...
@Data
public class ReturnYiQuantityModel {
    ...
    private Double jindu;  //工程量整体进度

    //构造函数
    public ReturnYiQuantityModel() {
    }

    public ReturnYiQuantityModel(String coding, String town, String name, String xiang_man, String construction,
                                 String team, String status, String ruhu_type, Double shitong,
                                 Double ruhu_mi, Double ruhu_hu, Double jiexu, Double xiangti, Double guanglan_4D,
                                 Double guanglan_8D, Double guanglan_12D, Double guanglan_24D,
                                 Double guanglan_48D, Double guanglan_72D, Double guanglan_96D, Double guanglan_144D,
                                 Double guanglan_288D, Double zhimai, Double kaiwa, Double dingguan, Double jindu) {
        this.coding = coding;
        this.town = town;
        this.name = name;
